...
describe('<Form />', () => {
  it('should render Form component properly', () => {
    ...
    const selectArrivalStation = screen.getByTestId('select-arrival-station')
    const selectDateOfDeparture = screen.getByTestId('select-departure-date')
    const selectTimeOfDeparture = screen.getByTestId('select-departure-time')
