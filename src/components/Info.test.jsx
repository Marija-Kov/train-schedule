...
describe("<Info/>", () => {
    it("should render Info component properly", () => {
        ...
        expect(linkToPdf).toHaveAttribute("href", "https://www.srbvoz.rs/wp-content/redvoznje/rv_bg_voza_za_2022.pdf")
        expect(linkToRepo).toHaveAttribute("href", "https://github.com/Marija-Kov/train-schedule")
